...
val description = "provides a simple state saver based on jetpack preferences"

// Module
val artifactId = "statesaver-preferences"
val androidNamespace = "com.michaelflisar.composechangelog.statesaver.preferences"
